        ...
        try
        {
            ...
            if (missing.Count > 0)
            {
                ...
                throw new FileNotFoundException(
                    "ZapretTR motor dosyaları eksik: " + string.Join(", ", missing));
            }
            ...
            if (!process.Start())
            {
                ...
                throw new InvalidOperationException("ZapretTR motoru başlatılamadı.");
            }
            ...
            if (process.HasExited)
            {
                ...
                throw new InvalidOperationException(
                    $"ZapretTR motoru erken kapandı (kod {exitCode}). Günlükleri kontrol edin.");
            }
